#!/bin/bash
# Restore pages part 1: Auth pages

echo "🔄 Restoring Auth pages..."

# Create Login.js
cat > /home/xoai/Chatbot/frontend/src/pages/Login.js << 'EOF'
...
echo "✅ Created Login.js"

# Run part 2 for remaining pages
bash /home/xoai/Chatbot/restore_pages_2.sh
